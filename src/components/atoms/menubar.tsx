...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.Trigger
        ref={ref}
        className={cn(
            'flex cursor-default select-none items-center rounded-sm px-3 py-1 text-sm font-medium outline-hidden hover:cursor-pointer  focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground',
            className,
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <MenubarPrimitive.Trigger
        ...
        className={cn(
            ...
            'flex cursor-default select-none items-center rounded-sm px-3 py-1 text-sm font-medium outline-hidden hover:bg-accent focus:text-accent-foreground ',
            className,
        )}
        {...props}
    />
))
MenubarButton.displayName = MenubarPrimitive.Trigger.displayName
...
export { Menubar, MenubarButton, MenubarCheckboxItem, MenubarContent, MenubarItem, MenubarMenu, MenubarTrigger }
